...
namespace SSO_DaL.Common
{
    ...
    public static class DBHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        static string SqlConnectstr = ConfigurationManager.ConnectionStrings["SqlConnectstr"].ConnectionString;
        ...
        public static int ExecuteNonQuery(CommandType commandType, string commandText, out string errorString, params SqlParameter[] commandParameters)
        {
            int result = -1;
            //异常信息
            errorString = null;
            ...
            try
            {
                ...
                {
                    connection.Open();
                    result = ExecuteNonQuery(connection, commandType, commandText, commandParameters);                  
                }
                else
                {
                    //获取异常信息
